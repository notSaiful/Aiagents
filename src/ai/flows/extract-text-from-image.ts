...
/**
 * @fileOverview A Genkit flow for extracting text from an image.
 *
...
const ExtractTextFromImageInputSchema = z.object({
  photoDataUri: z
    .string()
    .describe(
      "A photo of a document or handwriting, as a data URI that must include a MIME type and use Base64 encoding. Expected format: 'data:<mimetype>;base64,<encoded_data>'."
    ),
});
...
Pay close attention to preserving the original line breaks and structure where possible.
